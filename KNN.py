...
def handwriting_class_test():
    ...
    # for l in range(100):
    #    print  training_matrix[l]
    # print 'oooooo'
    # for j in training_matrix:
    #     for k in j:
    #          if j[k] == 0 :
    #             print j[k]

    print 'hw_labels=',hw_labels
    test_file_name = 'testDigits0'
    ...
    for i in range(m_test):
        ...
        classifier_result = classify(vector_under_test, training_matrix, hw_labels, 10)
        ...
        if class_name_str != classifier_result:
            error_result.append(filename_str)
            error_count += 1
    print error_result
